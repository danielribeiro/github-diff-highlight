	...
	if ( !($.SyntaxHighlighter||false) ) {
		$.SyntaxHighlighter = {
			...
			'config': {
				 ...
				 */
				'prettifyBaseUrl': 'https://raw.github.com/danielribeiro/jquery-syntaxhighlighter/master/prettify',

				/**
				 * The baseUrl to load our Syntax Highlighter from.
				 * This is used to load in the stylesheet and additional themes.
				 */
				'baseUrl': 'https://raw.github.com/danielribeiro/jquery-syntaxhighlighter/master'
			},
